...
@Component({
  selector: 'app-rank-by-defense-system',
  templateUrl: './rank-by-defense.page.html',
  styleUrls: ['./rank-by-defense.page.scss'],
  standalone: true,
  imports: [
...
export class RankByDefenseComponent implements OnInit {
  // Variables
  posts: any[] = [];
  ...
  async loadPosts(): Promise<void> {
    try {
      ...
      this.posts = allPosts.filter((post: { category: string }) => post.category === 'Defensa'); // Filtrar por la categoría de "gol"
