...
@Component({
  selector: 'app-rank-by-assistance-system',
  templateUrl: './rank-by-assistance.page.html',
  styleUrls: ['./rank-by-assistance.page.scss'],
  standalone: true,
  imports: [
...
export class RankByAssistanceComponent implements OnInit {
  // Variables
  posts: any[] = [];
  ...
  async loadPosts(): Promise<void> {
    try {
      ...
      this.posts = allPosts.filter((post: { category: string }) => post.category === 'Asistencia'); // Filtrar por la categoría de "gol"
